...
var DatatableComponent = /** @class */ (function () {
    ...
    Object.defineProperty(DatatableComponent.prototype, "innerWidth", {
        get: function () {
            return this._innerWidth;
        },
        set: function (val) {
    ...
    */
     ...
     */
    DatatableComponent.prototype.onResize = function (element) {
        this.recalculate();
    };
    /**
        ...
        this.resizeObserver = new resize_observer_polyfill_1.default(function (entries, observer) {
            for (var _i = 0, entries_1 = entries; _i < entries_1.length; _i++) {
                ...
                if (entry.target === _this.resizeElement) {
                    _this.resize.emit(entry.target);
                    break;
                }
            }
        });
